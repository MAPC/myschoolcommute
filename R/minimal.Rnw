...
\usepackage{fontspec} % table layout and font-family specs
\usepackage[margin=0.5in]{geometry}
\usepackage[font={bf,sf},% san-serif font for float captions
...
%\renewcommand{\familydefault}{\sfdefault} % set san-serif as default font
...
{\flushleft   
\includegraphics[height=20 mm]{2010SRTSLogo2}%[height=12 mm]{2010SRTSLogo}
\newline
\newline
\includegraphics[height=12 mm]{MassDOT_Logo_Color2}%[height=12 mm]{MassDOT_Logo_Color}
\newline
\newline
